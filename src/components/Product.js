...
const initialProducts = [
  { id: 1, name: 'Sample A', category: 'Category A', price: 10, stockQuantity: 100 },
  { id: 2, name: 'Sample B', category: 'Category B', price: 20, stockQuantity: 50 },
  { id: 3, name: 'Sample C', category: 'Category C', price: 30, stockQuantity: 500 },
  { id: 4, name: 'Sample D', category: 'Category D', price: 40, stockQuantity: 5 },
  { id: 5, name: 'Sample E', category: 'Category E', price: 50, stockQuantity: 10 },
];
